...
<div style="width:1080px; height:700px; display:block; background-color:#f4f9fd; margin-left:120px;">
...
<div style="width:500px; height:350px; margin-left:375px; margin-top:30px;" align="center"> 
<table width="500" height="64" border="0">
  <tr style="background:#ADD8E6;">
    <th width="500" height="28" colspan="2" scope="col"><span class="Style2">Boutique BU en ligne </span></th>
    </tr>
  <tr  style="background:#fff;">
    <td height="30" colspan="2" id="parametres"><a href="mon_profile.php">Boutique BU en ligne</a></td>
    </tr>
</table>
</div>
